...
(function($) {
	$.fn.progression = function(options) {
		...
		return this.each(function() {
			...
			$innerdiv=$this.find(".progress"); // On recherche si l'élément a déj�  été traité
	...
	function BuildBarre($this, o) {
		...
		$innerdiv.css({
			...
			height: '100%',
			overflow: 'hidden',
			background: '#98C781 url("/" + Core.applicationContext + "/media/imgs/layout/80ade5_40x100_textures_04_highlight_hard_100.png)repeat-x scroll 0 50%',
			color: o.aTextColor
		});
	...
	// Fonction pour aller �  une valeur précise
