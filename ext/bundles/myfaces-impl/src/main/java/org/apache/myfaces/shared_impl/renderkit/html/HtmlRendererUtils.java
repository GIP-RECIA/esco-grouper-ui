 ...
 * @version $Revision: 478531 $ $Date: 2006-11-23 12:07:47 +0100 (Do, 23 Nov 2006) $
 */
public final class HtmlRendererUtils {
            ...
            throws IOException
    {
        ...
        boolean autoScroll = MyfacesConfig.getCurrentInstance(facesContext.getExternalContext()).isAutoScroll();

        ScriptContext context = new ScriptContext(MyfacesConfig.getCurrentInstance(facesContext.getExternalContext())
            .isPrettyHtml());
        context.prettyLine();
