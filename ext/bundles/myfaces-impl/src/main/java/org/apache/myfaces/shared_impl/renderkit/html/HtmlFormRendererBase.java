 ...
 * @author Anton Koinov
 * @version $Revision: 486711 $ $Date: 2006-12-13 17:25:37 +0100 (Mi, 13 Dez 2006) $
 */
public class HtmlFormRendererBase
    ...
    public void encodeEnd(FacesContext facesContext, UIComponent component)
        ...
        if(!facesContext.getApplication().getStateManager().isSavingStateInClient(facesContext))
        {
            writer.startElement(HTML.INPUT_ELEM, component);
            writer.writeAttribute(HTML.TYPE_ATTR, HTML.INPUT_TYPE_HIDDEN, null);
            writer.writeAttribute(HTML.NAME_ATTR, org.apache.myfaces.shared_impl.renderkit.RendererUtils.SEQUENCE_PARAM, null);
            writer.writeAttribute(org.apache.myfaces.shared_impl.renderkit.html.HTML.VALUE_ATTR, org.apache.myfaces.shared_impl.renderkit.RendererUtils.getViewSequence(facesContext), null);
            writer.endElement(HTML.INPUT_ELEM);
        }
        */
