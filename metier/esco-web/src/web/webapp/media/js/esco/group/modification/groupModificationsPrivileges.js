 ...
 * @author aChesneau
 */
var GroupPrivilegesPrototype = $.extend( true, {}, EscoGrid ,{
    ...
    */
	...
	doAddNavButtons:function(){
		...
		var addAction = ActionNavBar.actionAddDefault(_this,"/" + Core.applicationContext + "/stylesheets/groupModifications/groupModifications.jsf",1);
		this._addANavButton(
		...
		var delAction = ActionNavBar.actionDelDefault(_this,"/" + Core.applicationContext + "/ajax/groupModificationsPrivilegesController/deleteItems.jsf",groupModification.getIsGroupModified);
		this._addANavButton(
